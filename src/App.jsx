...
import desktop from './images/mobleDesktop.png'
  ...
  return (
    <div className="App font-roboto text-center">
      <header className='bg-gray-600 '>
        <div className=' flex items-center justify-between p-4 lg:px-20 lg:py-6 font-bold text-[32px] text-white'>
          <div className='lg:flex lg:items-center lg:gap-12'>
           <p>mabi</p>
           <div className='items-center gap-12 font-medium text-base hidden lg:flex'>
            <a href="#">Home</a>
            <a href="#">Solutions</a>
            <a href="#">Pricing</a>
            <a href="#" className='flex items-center gap-2'>Resources<VectorWindow className='-rotate-90 fill-white w-2'/></a>
           </div>
          </div>
          <div className='lg:font-medium lg:text-base lg:flex lg:gap-4'>
            ...
            <button className='font-bold p-3 border-2 rounded-full border-white hidden lg:block'>Free Launch</button>
            <button className='font-bold p-3 border-2 rounded-full bg-white text-gray-600 border-white hidden lg:block'>Free Launch</button>
          </div>
        </div>
      </header>
      <section className='text-white '>
        <div className='lg:relative lg:grid lg:grid-cols-2 lg:items-center lg:px-20 bg-gray-100'>
          <div className='space-y-8 px-4 lg:p-0 pt-7 pb-8 bg-gray-600 lg:bg-transparent lg:text-left lg:z-20'>
            <div className='font-bold lg:font-extrabold'>
              <p className='text-[40px] xl:text-7xl'>Launch Your App</p>
              <p className='text-[32px] xl:text-[56px] text-gray-300'>Grow Your Business</p>
            </div>
            <p className='text-lg xl:text-2xl'>Amet nunc diam orci duis ut sit diam arcu, nec. Eleifend proin massa tincidunt viverra lectus pulvinar.</p>
          ...
          <div className='relative lg:w-full ml-auto z-10 lg:z-20'>
            ...
            <div className='mx-auto w-fit lg:w-full z-0'>
              <img src={mobile} className='lg:w-full' alt="" />
            </div>
          </div>
        ...
        <div className='bg-gray-100'>
          <div className='py-12 px-4 space-y-8'>
            <p className='font-bold text-[32px] text-gray-900 lg:font-extrabold lg:text-[56px]'>Our Top Partners</p>
            <div className='flex flex-col space-y-4 items-center'>
              <div className='flex gap-4 flex-wrap'>
                <div className='flex font-bold text-xs items-center gap-1 text-gray-900'><Logo className='w-5 h-5 lg:w-8 lg:h-8' /><p>Astrom</p></div>
                <div className='flex font-bold text-xs items-center gap-1 text-gray-900'><Logo1 className='w-5 h-4 lg:w-8 lg:h-8' /><p>cicio</p></div>
                <div className='flex font-bold text-xs items-center gap-1 text-gray-900'><Logo2 className='w-5 h-4 lg:w-8 lg:h-8' /><p>weavy</p></div>
                <div className='flex font-bold text-xs items-center gap-1 text-gray-900'><Logo3 className='w-5 h-5 lg:w-8 lg:h-8' /><p>vRokets</p></div>
                <div className='flex font-bold text-xs items-center gap-1 text-gray-900'><Logo4 className='w-6 h-5 lg:w-8 lg:h-8' /><p>viewio</p></div>
              </div>
              <div className='flex gap-4 flex-wrap'>
                <div className='flex font-bold text-xs items-center gap-1 text-gray-900'><Logo5 className='w-5 h-4 lg:w-8 lg:h-8' /><p>Metablu</p></div>
                <div className='font-bold text-xs text-gray-900'><Logo6 className='w-8 h-3 lg:w-10' /><p>Buildaa</p></div>
                <div className='flex font-bold text-xs gap-1 items-center text-gray-900'><Logo7 className='w-5 h-5 lg:w-8 lg:h-8' /><p>hapi</p></div>
                <div className='flex font-bold text-xs gap-1 items-center text-gray-900'><Logo8 className='w-8 h-8 lg:w-8 lg:h-8' /></div>
                <div className='flex font-bold text-xs gap-1 items-center text-gray-900'><Logo9 className='w-5 h-3 lg:w-8 lg:h-8' /><p>virtuo</p></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className='px-4 py-12 space-y-8'>
        <p className='font-bold text-[32px] lg:font-extrabold lg:text-[56px]'>How it works</p>
        <div className='space-y-8 lg:space-y-0 lg:gap-8 max-w-sm mx-auto lg:max-w-none lg:flex'>
          <div className='border-4 border-gray-400 rounded-xl'>
            <div className='px-4 py-8 space-y-4'>
              <Timer className='mx-auto'/>
              <p className='text-base lg:text-xl text-gray-900'>
      ...
      <section className='px-4 py-12 lg:p-20 lg:items-center bg-gray-100 lg:grid lg:grid-cols-2'>
        <div className='space-y-8 lg:text-left'>
          <p className='font-bold text-[32px] lg:font-extrabold lg:text-[56px]'>Turpis risus facilisi</p>
        ...
        <div className=''>
          <div className='relative w-fit mx-auto mt-16 lg:mt-0'>
            <div>
      ...
      <section className='px-4 py-12 lg:p-20 space-y-8 lg:items-center bg-gray-100 lg:grid lg:grid-cols-5'>
        <div className='space-y-8 lg:order-last lg:col-span-3 lg:text-left'>
          <p className='font-bold text-[32px] lg:font-extrabold lg:text-[56px]'>Sagittis sapien viverra</p>
          <p className='text-base lg:text-xl'>
        ...
        <div  className='w-fit mx-auto lg:col-span-2'>
      ...
      <section className='px-4 py-12 lg:p-20 lg:items-center space-y-8 bg-gray-100 lg:grid lg:grid-cols-5'>
        <div className='space-y-8 lg:col-span-3 lg:text-left'>
          <p className='font-bold text-[32px] lg:font-extrabold lg:text-[56px]'>Non commodo nec</p>
          <p className='text-base lg:text-xl'>
      ...
      <section className='relative -z-20 bg-gray-100'>
        ...
        <div className='lg:grid lg:grid-cols-2 lg:items-center lg:p-20'>
          ...
          <div className='bg-gray-600 lg:bg-transparent space-y-8 text-white pb-20 lg:pb-0 lg:text-left'>
            <p className='font-bold text-[32px] lg:font-extrabold xl:text-[56px]'>Launch Your App Today</p>
            <p className='text-base xl:text-2xl'>Amet nunc diam orci duis ut sit diam arcu, nec. Eleifend proin massa tincidunt viverra lectus pulvinar.</p>
            <button className='font-bold text-2xl px-12 py-5 border-2 rounded-full border-white'>Free Launch</button>
          </div>
      ...
      <footer className='bg-gray-600 px-4 lg:px-20 text-white'>
        <div className='py-12 space-y-14 lg:space-y-0 border-b border-gray-700 lg:grid lg:grid-cols-6 lg:text-left'>
          <p className='font-bold text-[32px] lg:-mt-4'>mabi</p>
